...
of building the join tree can be related to the cost of building $\cC(\MM)$.
...
On a given input simplicial complex, we first we break it into extremum dominant pieces using $\rain(\MM)$ (and in $O(|\MM|)$ time by \Thm{rain-time}).  
