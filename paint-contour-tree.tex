...
time being stated as a function of our algorithm.  So rephrase or add remark/footnote saying controlling which path decomp is used is like knowing the right ordering 
before sorting, but unlike sorting, there are certain contour tree shapes such that there is no bad path decomp.  This somewhat said in the paragraph below, 
but reviewers are not getting it.}.
