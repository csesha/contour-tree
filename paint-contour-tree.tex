...
comparisons in the worst-case over this set. (All further details are in \InSoCGVer{Appendix~}\Sec{lb}.)
...
Additional definitions and proofs are given in \Sec{jstedm}.
}
...
Given the above technical definition, the proof of the following lemma is straightforward, though long and so has been moved to \Sec{runTimeProof}.
