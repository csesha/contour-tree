...
$O(\sum_{p\in P'} |p|\log|p| + N\alpha(N))$, where $N$ is total complexity of the input manifold 
...
trees of a minimum dominant simplicial complex $\MM$. As part of the initialization, we determine
...
of \emph{painting} of $\MM$. Initially associate a color with each maximum. Denoting the set of maxima by $X$,
