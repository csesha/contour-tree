...
\begin{figure}[h]\centering
    \includegraphics[width=.7\linewidth,height=.3\linewidth]{figs/balanced4}
    \vspace{.1in}

    \includegraphics[width=.7\linewidth,height=.25\linewidth]{figs/trees}
...
\begin{figure}[h]\centering
    \includegraphics[width=.25\linewidth]{figs/tent2}%
    \hspace{.9in}
    \includegraphics[width=.25\linewidth]{figs/tent1}
