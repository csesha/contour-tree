...
In particular, any comparisons made are only between ancestors and descendants in the contour tree, where as previous algorithm compared everything, 
and that is where we gain.
...
%
We define a class of valid path decompositions which characterizes decompositions produced by our algorithm.
%
%We define a class of valid path decompositions.  This include any decomposition of rooted trees,
%and more generally is a large superset of all decomposition produced by our 
%algorithm.
%\footnote{Our construction likely works for any decomposition, however, 
%to keep the presentation simple we restrict to a subset relevant for our algorithm.}
%
...
Fix a path decomposition $P$. There is a family of terrains, $\bF_P$, all with the same triangulation, 
...
\Thm{main-lb} now follows immediately from an entropy argument, analogous to \Thm{joinLB}.
%
%
