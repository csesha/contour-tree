...
\begin{proof}
 ...
 Specifically, we say a \emph{diamond} of size $m$ is the following terrain.  To start, construct a cycle 
 ...
 At this point we can construct the entire terrain, by gluing together diamonds.  
 ...
 $p$ is the parent of $q$ in $\pathTree$, we glue the outer triangular cap of the diamond for $q$ onto the triangular ``platform'' of some face of the diamond for $p$.
 ...
 diamonds, and there is exactly one minima corresponding to the outer cap of the diamond representing the root of $\pathTree$.  Therefore, the saddles on a given 
 diamond will appear contiguously on a root to leaf path in the join tree of the terrain, where the leaf corresponds to the maxima of the diamond 
...
there is some path decomposition $\overline{P}(T)$ (of the tree $f$ defines) such that 
each path $p$ consists exactly of the set of critical points from a given diamond. 
...
path decomposition of $T$.
 ...
 Consider the set of joins around any diamond.  All these joins have an edge which connects 
