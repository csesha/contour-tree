...
\subsection{Proving \Lem{light}} \label{sec:light}
...
We now construct the shrub of unsupported light paths $\cU$. Consider $p \in \cL \setminus \cL'$,
and traverse the chain of ancestors 
