...
This leads to a linear time algorithm for contour tree computation for many
classes of natural instances. We complement with matching lower bounds for contour tree computation.
