...
\begin{theorem} \label{thm:alg-main} Consider $f:\MM \mapsto \RR$ that is PL-Morse, where the contour tree $T$
...
(In the example, $t = \Omega(n)$.) The running time promised by \Thm{alg-main}
