...
\Ben{Mention lower bound an analysis sections which are going to be moved to appendix.}
...
%%%%%%%%%%%%%%%%%%%%
\InSoCGVer{
\subsection{Upper and Lower bounds for Running Time}
We now bound the running time of the algorithm of \Sec{algo}. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\Ben{Summarize \Sec{runTime} on the run time in terms of heap sizes.}

\Ben{Summarize \Sec{pathDecomp} on path decomposition upped bound here.}

\Ben{summarize \Sec{lb}, the lower bound section, result here.}
