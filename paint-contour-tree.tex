...
slightly differ from those in the main body\SubmitVer{ of the full version}. They may also differ from the original definitions proposed
in earlier work. 
...
\FullVer{Later, in Definition~\ref{def:criticalJoin}, we define the critical join tree on a certain subset of $\cV$.}
\SubmitVer{In the full version we define the critical join tree on a certain subset of $\cV$.}
...
Abusing notation, for now we will just call this the join tree. (In \SubmitVer{the full version}\FullVer{Section~\ref{sec:extreme}} we carefully handle the distinction 
