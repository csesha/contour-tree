...
hence must pay $\Omega(t\log t)$ for all instances. Can we beat this sorting bound for some instances
and characterize what inputs are hard? Our main result gives an affirmative answer. First, we require some technical definitions.
