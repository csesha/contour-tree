...
We require the following definition of \emph{ripe} vertices.
...
and requires a significantly more sophisticated analysis involving path decompositions, which is provided in the next section.
